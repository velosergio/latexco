...
<head>
  ...
  <title>Latexco - Forgot Password</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">No te preocupes, ingresa el correo elecotnrico con el que te registraste
                      y te enviaremos una nueva clave!</p>
                  </div>
                  <form class="user">
